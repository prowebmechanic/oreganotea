// Summarizes a note using AI, extracting key topics and generating a concise summary.
...
const SummarizeNoteOutputSchema = z.object({
  ...
  keyTopics: z.string().describe('A comma-separated list of key topics covered in the note.'),
});
...
const summarizeNotePrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following note and extract the key topics.\n\nNote:\n{{{noteContent}}}\n\nSummary:\nKey Topics (comma-separated):`,
});
